...
<body>
    <div class="login-container">
                ...
                <form action="controllers/login.php" method="POST">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="correo@empresa.com" required autofocus>
                        </div>
                    </div>
        ...
        <div class="footer-login">
            Sistema de Tickets de Soporte - Programación para Internet III
        </div>
    </div>
